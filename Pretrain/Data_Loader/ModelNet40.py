...
class ModelNet40_pretrain(Dataset):
...
def get_sets(data_path,fold=0):
    train_dataset=ModelNet40_pretrain(root=data_path,fold=fold)
...
if __name__=='__main__':
    data_root='/data1/jiajing/dataset/see_like_human/ModelNet40-LS'
    ...
    dataset=ModelNet40_pretrain(data_root)
